...
urlpatterns = [
    ...
    path('<int:pk>/applications/review/bulk/', views.JobReviewBulkApplicationsView.as_view(), name='review-bulk'),
    path('<int:pk>/applications/<int:application_id>/review/', views.JobReviewSingleApplicationView.as_view(), name='review-single'),
